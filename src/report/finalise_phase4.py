"""
Finalise the Phase 4 report: open it in Word, update the table of contents,
...
PowerShell is the working route (same as finalise_phase2.py / finalise_phase3.py).

Run:  python src/report/finalise_phase4.py
"""
...
DOCX = ROOT / "Phase4_Report.docx"
PDF = ROOT / "Phase4_Report.pdf"
...
def main() -> int:
    if not DOCX.exists():
        print(f"missing {DOCX}; run build_phase4_docx.py first")
        return 1
