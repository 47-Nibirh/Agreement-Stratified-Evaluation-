"""
Finalise the Phase 3 report: open it in Word, update the table of contents,
...
PowerShell is the working route (same as finalise_phase2.py).

Run:  python src/report/finalise_phase3.py
"""
...
DOCX = ROOT / "Phase3_Report.docx"
PDF = ROOT / "Phase3_Report.pdf"
...
def main() -> int:
    if not DOCX.exists():
        print(f"missing {DOCX}; run build_phase3_docx.py first")
        return 1
