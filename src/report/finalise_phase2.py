"""
Finalise the Phase 2 report: open it in Word, update the table of contents,
...
PowerShell is the working route.

Run:  python src/report/finalise_phase2.py
"""
...
DOCX = ROOT / "Phase2_Report.docx"
PDF = ROOT / "Phase2_Report.pdf"
...
def main() -> int:
    if not DOCX.exists():
        print(f"missing {DOCX}; run build_phase2_docx.py first")
        return 1
