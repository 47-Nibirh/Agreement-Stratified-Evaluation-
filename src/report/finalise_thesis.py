"""
Finalise the thesis: open it in Word, update the table of contents,
...
Run:  python src/report/finalise_thesis.py
"""
...
def main() -> int:
    if not DOCX.exists():
        print(f"missing {DOCX}; run build_thesis_docx.py first")
        return 1
